...
github_user="Prodis"
github_repository="wifimas"
branch="master"
script_filename="wifimas.sh"
...
function language_strings_handling_messages() {
	...
	language_strings_try_to_download["ENGLISH"]="wifimas will try to download the language strings file..."
	language_strings_try_to_download["SPANISH"]="wifimas intentará descargar el fichero de traducciones..."
	language_strings_try_to_download["FRENCH"]="wifimas va essayer de télécharger les fichiers de traductions..."
	language_strings_try_to_download["CATALAN"]="wifimas intentarà descarregar el fitxer de traduccions..."
	language_strings_try_to_download["PORTUGUESE"]="O wifimas tentará baixar o arquivo de tradução..."
	language_strings_try_to_download["RUSSIAN"]="wifimas попытается загрузить языковой файл..."
	language_strings_try_to_download["GREEK"]="Το wifimas θα προσπαθήσει να κατεβάσει το αρχείο γλωσσών..."
	language_strings_try_to_download["ITALIAN"]="wifimas cercherá di scaricare il file delle traduzioni..."
	language_strings_try_to_download["POLISH"]="wifimas spróbuje pobrać plik tłumaczeń..."
	language_strings_try_to_download["GERMAN"]="wifimas wird versuchen, die Übersetzungsdatei herunterzuladen..."
	language_strings_try_to_download["TURKISH"]="wifimas çeviri dosyasını indirmeye çalışacak..."
	language_strings_try_to_download["ARABIC"]="سيحاول wifimas تنزيل ملف سلاسل اللغة ..."
	language_strings_try_to_download["CHINESE"]="wifimas 将尝试下载语言支持文件..."
...
function credits_option() {
	...
	echo
	sleep 0.15 && echo -e "${yellow_color} Developed by Prodis  ${green_color} "
	sleep 0.15 && echo -e "${yellow_color}  MasterHackTeam ${green_color} "
	sleep 0.15 && echo -e "https://masterhackteam.com"
	echo
...
function print_intro() {
	...
	echo -e "${yellow_color}                              Prodis Wifi Hack "
	sleep 0.15 && echo -e "                             Developed by Prodis  "
	sleep 0.15 && echo -e "                               MasterHackTeam"
	sleep 0.15 && echo -e "                                 "
	sleep 0.15 && echo -e "                          https://masterhackteam.com   "
...
#Kill tmux session started by wifimas
